class Board
{
	...
	Tile?[,] Tiles { get; set; } =
	{
		...
		{ new(7,0,"tile42","enterRed"), new(7,1,"darkredPath1","darkredPath2","darkred"), new(7,2,"darkredPath2","darkredPath3","darkred"), new(7,3,"darkredPath3","darkredPath4","darkred"), new(7,4,"darkredPath4","darkredPath5","darkred"), new(7,5,"darkredPath5","darkredPath6","darkred"), new(7,6,"darkredPath6","center","darkred"), new(7,7,"center","", "white", true), new(7,8,"darkgreenPath6","center","darkgreen"), new(7,9,"darkgreenPath5","darkgreenPath6","darkgreen"), new(7,10,"darkgreenPath4","darkgreenPath5","darkgreen"), new(7,11,"darkgreenPath3","darkgreenPath4","darkgreen"), new(7,12,"darkgreenPath2","darkgreenPath3","darkgreen"), new(7,13,"darkgreenPath1","darkgreenPath2","darkgreen"), new(7,14,"tile14","enterGreen") },
